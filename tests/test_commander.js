...
for (let n = 2; n <= 8; n++) {
    ...
    for (let s of stations) {
        // Must be connected to home or another station within 4.5
...
const poly6 = getTerritoryPolygon(p1Home, stations6);
const area6 = polygonArea(poly6);

const stations5 = computeStationPositions(p1Home, 5, false);
const poly5 = getTerritoryPolygon(p1Home, stations5);
...
const poly3 = getTerritoryPolygon(p1Home, computeStationPositions(p1Home, 3, false));
